...
namespace CSharpFunctionalExtensions.Tests.MaybeTests.Extensions
{
    public class ToResultTests_Task_Left : MaybeTestBase
    {
        ...
        [Fact]
        public async Task ToResult_Task_Left_returns_custom_failure_via_error_function_if_has_no_value()
        {
            Maybe<T> maybe = null;
        ...
        [Fact]
        public async Task ToResult_Task_Left_custom_failure_with_error_function_returns_success_if_has_value()
        {
            var maybe = Maybe<T>.From(T.Value);

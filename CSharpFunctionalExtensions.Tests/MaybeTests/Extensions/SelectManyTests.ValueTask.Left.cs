...
{
    public class SelectManyTests_ValueTask_Left
    {
        [Fact]
        public async Task SelectMany_ValueTask_Left_returns_projection_if_maybes_have_values()
        {
        ...
        [Fact]
        public async Task SelectMany_ValueTask_Left_returns_no_value_if_source_has_no_value()
        {

...
{
    public class MapAsyncLeftTests : MapTestsBase 
    {
        [Fact]
        public async Task Map_AsyncLeft_executes_on_success_returns_new_success()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_T_executes_on_success_returns_new_success()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_T_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_T_E_executes_on_success_returns_new_success()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_T_E_executes_on_failure_returns_new_failure()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_unit_result_E_executes_on_success_returns_success()
        {
        ...
        [Fact]
        public async Task Map_AsyncLeft_unit_result_E_executes_on_failure_returns_failure()
        {

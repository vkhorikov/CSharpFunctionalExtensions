...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public abstract class BindIfTestsBase : TestBase
    {
        ...
        protected Func<Task<Result>> GetAsyncAction(bool isSuccess)
        {
            if (!isSuccess)
            {
        ...
        protected Func<T, Task<Result<T>>> GetAsyncValueAction(bool isSuccess)
        {
            if (!isSuccess)
            {
        ...
        protected Func<Task<UnitResult<E>>> GetAsyncErrorAction(bool isSuccess)
        {
            if (!isSuccess)
            {
        ...
        protected Func<T, Task<Result<T, E>>> GetAsyncValueErrorAction(bool isSuccess)
        {
            if (!isSuccess)
            {
